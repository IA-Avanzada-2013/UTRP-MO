...
utrpmo: main.o
	g++ $(OPTS) -o utrpmo main.o common.o DataHandler.o Problem.o BusStop.o Route.o RouteInfo.o

main.o: main.cpp common.o DataHandler.o Problem.o BusStop.o Route.o RouteInfo.o
	g++ $(OPTS) -c main.cpp
